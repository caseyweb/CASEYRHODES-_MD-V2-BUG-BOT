...
async function Telesticker(url) {
    return new Promise(async (resolve, reject) => {
        ...
        for (let i = 0; i < data.data.result.stickers.length; i++) {
            ...
            status: 200,
            author: 'CASEYRHODES',
            url: "https://graph.org/file/eb00d4051de06f6939ace.jpg:AAHWB1dQd-vi0IbH2NjKYUk-hqQ8rQuzPD4/" + data2.data.result.file_path
            }
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "🦄드림 가이 Xeon",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://files.catbox.moe/7x8qqf.jpg" } }, { upload: GlobalTechInc.waUploadToServer }))
      },
      body: {
        text: ""
      },
