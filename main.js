...
XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
	        ...
	        console.log(chalk.magenta(`\n${themeemoji} YT CHANNEL: Caseyrhodes`))
            console.log(chalk.magenta(`${themeemoji} GITHUB: CASEYRHODES-_MD-V2-BUG-BOT`))
            console.log(chalk.magenta(`${themeemoji} INSTAGRAM: @caseywebs`))
